...
{
    TreeVisitingMode VisitingMode
    {
        get;
    }
    bool StopOnDataTemplate
    {
        get;
    }
    bool VisitNodeOnDataTemplate
    {
        get;
    }
    bool StopOnResourceDictionary
    {
        get;
    }
...
class XamlNodeVisitor : IXamlNodeVisitor
{
    ...
    public TreeVisitingMode VisitingMode
    {
        get;
    }
    ...
    public bool VisitNodeOnDataTemplate
    {
        get;
    }
