...
namespace Maui.ServerDrivenUI.Xaml
{
    ...
    {
        Dictionary<XmlName, INode> Properties
        {
            get;
        }
        List<XmlName> SkipProperties
        {
            get;
        }
        NameScopeRef NameScopeRef
        {
            get;
        }
        XmlType XmlType
    ...
    class XmlType
    {
        ...
        public IList<XmlType> TypeArguments
        {
            get;
        }
    ...
    class ElementNode : BaseNode, IValueNode, IElementNode
    {
        ...
        public Dictionary<XmlName, INode> Properties
        {
            get;
        }
        public List<XmlName> SkipProperties
        {
            get;
        }
        public List<INode> CollectionItems
        {
            get;
        }
        ...
        public NameScopeRef? NameScopeRef
        {
            get; set;
        }
